...
import com.example.shoppinglist.features.listDetailScreen.data.repository.ProductNameRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindProductNameRepository(
        impl: ProductNameRepositoryImpl
